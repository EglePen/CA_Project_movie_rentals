    ...
    <form action="{{ route('admin.actors.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="first_name" id="first-name" placeholder="@lang('app.first_name')">
            </div>

            <div class="form-group">
                <label for="last-name">@langTitle('app.last_name')</label>
                <input type="text" class="form-control" name="last_name" id="last-name" placeholder="@lang('app.last_name')">
            </div>

            <div class="form-group">
                <label for="date-of-birth">@langTitle('app.date_of_birth')</label>
                <input type="date" class="form-control" name="date_of_birth" id="date-of-birth" placeholder="@lang('app.date_of_birth')">
            </div>
