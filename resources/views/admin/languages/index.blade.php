                    ...
                    <tbody>
                        ...
                        @foreach ($models as $model)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href='{{ route('admin.languages.edit', $model) }}' type="button" class="btn btn-info">
                                            @langTitle('app.edit')
                                        </a>
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <a onclick="event.preventDefault()" class="dropdown-item delete" href="{{ route('admin.languages.destroy', $model) }}">
